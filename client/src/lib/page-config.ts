...
export const PAGE_COLORS: PageColor[] = [
  ...
  { key: 'lemon',    name: 'Limón',    bg: '#F1F0B4' },
  { key: 'sun',      name: 'Sol',      bg: '#F6E38F' },
  { key: 'ocre',     name: 'Ocre',     bg: '#F0E4C8' },
  { key: 'peach',    name: 'Durazno',  bg: '#FCDDC5' },
  { key: 'mandarin', name: 'Mandarina', bg: '#F6C289' },
  { key: 'coral',    name: 'Coral',    bg: '#F5C8A8' },
  { key: 'salmon',   name: 'Salmón',   bg: '#F5B7A3' },
  { key: 'rose',     name: 'Rosa',     bg: '#F4DDDD' },
  { key: 'flamingo', name: 'Flamenco', bg: '#F3C3D3' },
  { key: 'plum',     name: 'Ciruela',  bg: '#D2BCE0' },
  { key: 'lavender', name: 'Lavanda',  bg: '#E2D9F1' },
  { key: 'sky',      name: 'Cielo',    bg: '#D9E8F4' },
  { key: 'ice',      name: 'Hielo',    bg: '#E4F0F2' },
  { key: 'aqua',     name: 'Agua',     bg: '#C7E6EA' },
  ...
  { key: 'rust',     name: 'Óxido',    bg: '#B5715A' },
  { key: 'cocoa',    name: 'Cacao',    bg: '#8D6E58' },
  { key: 'grape',    name: 'Uva',      bg: '#9A87B8' },
  { key: 'fig',      name: 'Higo',     bg: '#7E6480' },
  { key: 'pine',     name: 'Pino',     bg: '#8FAF97' },
  { key: 'jungle',   name: 'Selva',    bg: '#77A06B' },
  { key: 'bottle',   name: 'Botella',  bg: '#4F6B57' },
  { key: 'swamp',    name: 'Pantano',  bg: '#8E9A6D' },
  { key: 'wine',     name: 'Vino',     bg: '#A86B7E' },
  { key: 'eggplant', name: 'Berenjena', bg: '#6B5470' },
  { key: 'ocean',    name: 'Océano',   bg: '#7D93B5' },
  { key: 'navy',     name: 'Marino',   bg: '#5C6E96' },
  { key: 'storm',    name: 'Tormenta', bg: '#75818F' },
  { key: 'graphite', name: 'Grafito',  bg: '#8A8D94' },
  { key: 'charcoal', name: 'Carbón',   bg: '#5C5852' },
];
...
export const PAGE_TITLE_SIZES: PageTitleSize[] = [
  ...
  { key: 'xl', name: 'Gigante', fontSize: 38, lineHeight: 44 },
];
...
export const PAGE_TEXTURES: PageTexture[] = [
  ...
  { key: 'honeycomb',  name: 'Panal' },
  { key: 'checker',    name: 'Damero' },
  { key: 'bubbles',    name: 'Burbujas' },
  { key: 'confetti',   name: 'Confeti' },
  { key: 'flowers',    name: 'Flores' },
  { key: 'hearts',     name: 'Corazones' },
  { key: 'bolts',      name: 'Rayos' },
  { key: 'sparkles',   name: 'Destellos' },
  { key: 'moons',      name: 'Lunas' },
  { key: 'suns',       name: 'Soles' },
  { key: 'drops',      name: 'Gotas' },
  { key: 'mountains',  name: 'Montañas' },
